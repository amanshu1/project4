...
<body>
	<jsp:useBean id="bean" class="in.com.rays.ORSprojectt4.bean.CourseBean" scope="request"></jsp:useBean>
...
<table>
	...
	<td><input type="text" name ="name" placeholder="Enter Course Name" size="20" value="<%=DataUtility.getStringData(bean.getCourseName())%>">
