...
<%@page import="in.com.rays.ORSprojectt4.model.MarksheetModel"%>
<%@page import="in.com.rays.ORSprojectt4.utility.HTMLUtility"%>
<%@page import="in.com.rays.ORSprojectt4.servlet.MarksheetListCtl"%>
...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="POST">
			...
			<jsp:useBean id="bean" class="in.com.rays.ORSprojectt4.bean.MarksheetBean"
			...
			<table width="100%">
				<tr>
					<td align="center"><label> Name :</label> <input type="text"
						...
						&emsp; <label>RollNo :</label> <%=HTMLUtility.getList("rollNo", String.valueOf(bean.getId()), roll)%>&emsp;
