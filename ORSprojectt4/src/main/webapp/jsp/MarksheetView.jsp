...
<!DOCTYPE html>
<%@page import="in.com.rays.ORSprojectt4.servlet.MarksheetCtl"%>
		...
		<center>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="physics" size=20
				...
				<tr>
					...
					<td><input type="text" name="chemistry" size=20
				...
				<tr>
					...
					<td><input type="text" name="maths" size=20
